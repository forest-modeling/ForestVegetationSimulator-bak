...
C----------
C     VARIABLES ADDED DURING RW UPDATES 2021
C----------
...
C----------
C  MOVED SITE INDEX REFERENCE TO TOP TO DO RW CALCS FIRST AND
C  BYPASS REMAINING CODE FOR PROCESSING EFFICIENCY
C  RW EDITS ONLY CALCULATE HEIGHT GROWTH
C    RW DIA GROWTH FOR SMALL TREES HANDLED BY REGENT.F
C----------
      SI= SITEAR(ISPC)
C
      IF (ISPC .EQ. 17) THEN
